...
class AuthServiceImpl(
    ...
    override suspend fun authorize(): MainGenericResponse<String?> {
        return httpClient.get {
            url {
                takeFrom(BASE_URL_AUTH)
                encodedPath += "${API_KEY}/${AuthService.AUTHORIZE}"
                parameters.append("code_challenge_method", "S256")
                parameters.append("code_challenge", "0ChgyTpVc9hkDJ3ag43oCPNpLanxTE111a_q4vYfUR8")
                parameters.append("scope", "openid%20profilepsf")
